...
tunedfilename=['.\Parameter\', int2str(m), '-bestcg','.txt'];   %Optimal parameters and accuracy
...
possize = 6536+datasize;         %%Cross-validated subset size, 6536+3000
