function sol = test(m) 
   ...
   gg = parameter(:,2);   %best parameter of c
   ...
   mygg = 2^(gg);
    ...
    %test 3 variable and 2 polynomial data,data is from 26145 to 32680 
    ...
    dlmwrite(testinfoASGfilename,accuracy3(1),'delimiter',' ', 'precision', '%.10f');
     ...
     %test 2 variable and 2 polynomial data,data is from 26145 to 32680
     disp('test 2 variable and 2 polynomial data ');
    testdata4 =  dlmread(test2v2pfilename);
    testdata4 = testdata4(26145:32680,:);       
